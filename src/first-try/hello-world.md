...
还记得大明湖畔等你的 [VSCode IDE](https://beatai.org/rust-course/first-try/editor) 和通过 `Cargo` 创建的 [世界，你好](https://beatai.org/rust-course/first-try/cargo) 工程吗？

现在使用 VSCode 打开 [上一节](https://beatai.org/rust-course/first-try/cargo) 中创建的 `world_hello` 工程，然后进入 `main.rs` 文件。（此文件是当前 Rust 工程的入口文件，和其它语言几无区别。）
